    ...
    <div className="max-w-6xl mx-auto py-10 md:py-20">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="space-x-4 flex pt-4 md:pt-0 items-center">
          ...
          <a
            href="https://twitter.com/michaelyang96"
            className="text-base font-normal text-gray-600 dark:text-gray-300"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <a
            href="https://github.com/mch-yang"
            className="text-base font-normal text-gray-600 dark:text-gray-300"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <a
            href="https://linkedin.com/in/chengzhouyang"
            className="text-base font-normal text-gray-600 dark:text-gray-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          >
            {mounted && (
              <svg
                ...
                fill="white"
                stroke="currentColor"
                className="w-4 h-4 text-gray-600 dark:text-yellow-500"
              >
                {theme === "dark" ? (
                  <path
                    strokeLinecap="round"
