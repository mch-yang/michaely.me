...
export default function NowPlaying() {
  ...
  return (
    <div className="flex flex-row-reverse sm:flex-row items-center mb-8 space-x-0 sm:space-x-2 w-full">
      ...
      <div className="inline-flex sm:flex-row w-full max-w-full truncate">
        {data?.songUrl ? (
          <a
            className="flex grow flex-row capsize rounded-lg pt-4 pb-4 hover:bg-gray-100 dark:hover:bg-zinc-800"
            href={data.songUrl}
            target="_blank"
