  ...
  return (
    <div className='bg-gray-50 dark:bg-zinc-900'>
      <Head>
        ...
        <meta property="og:url" content={`https://michaely.me${router.asPath}`} />
        <link rel="canonical" href={`https://michaely.me${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Michael Yang" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta name="twitter:site" content="@michaelyang96" />
